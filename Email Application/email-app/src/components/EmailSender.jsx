...
function EmailSender() {
  ...
  return (
    <div className="w-full min-h-screen flex justify-center items-center">
      <div className="email_card md:w-1/2 w-full  mx-4 md:mx-0 -mt-10 bg-white dark:bg-gray-700 dark:text-white dark:border-none rounded-lg p-4 rounded border shadow">
        ...
        <form action="" onSubmit={handleSubmit}>
          ...
          <div className="form_field mt-4">
            ...
            onEditorChange={(event) =>{
              ...
              apiKey="h3pl2g8n4dp8zly1guod9bilqgv8jm5qkuu47qa36zcawpsg"
              init={{
                plugins: [
